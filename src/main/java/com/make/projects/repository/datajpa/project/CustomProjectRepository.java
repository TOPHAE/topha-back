...
public interface CustomProjectRepository {
    ...
    Page<Project> selectAllProject(Pageable pageable, ProjectConditionSearch projectConditionSearch, boolean isjavascript,boolean isSpring, boolean isPhp,boolean isReact, boolean isPython);
}